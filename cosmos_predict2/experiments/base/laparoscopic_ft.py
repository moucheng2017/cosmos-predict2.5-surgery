...
predict2_video2world_training_2b_cosmos_laparoscopic = dict(
    defaults=[
    ...
    job=dict(
        ...
        group="video2world_ft",
        name="2b_cosmos_laparoscopic_93frames_ft_2000iter",
    ),
...
for _item in [
    predict2_video2world_training_2b_cosmos_laparoscopic,
